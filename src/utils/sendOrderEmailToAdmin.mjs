...
const sendOrderEmailToAdmin = async (orderDetails, transporter) => {
                  ...
                  <table>
                                    ...
                                    ? `
                                      <tr>
                                        <td colspan="4">
                                          ...
                                          ${item.size ? `Variant: ${item.size} ${item?.unit || ''}` : ""}
                                        </td>
                                      </tr>
                                    `
                                    : ""
                      ...
                      <tfoot>
                          ...
                          <tr>
                              ...
                              <td>৳${order.discount} ${order.voucher || ""}</td>
                          </tr>
                          <tr>
